...
<head>
  ...
  <?= $this->Html->css(['owl.carousel.min', 'bootstrap', 'style', 'responsive', 'font-awesome.min']) ?>
...
<body>
      ...
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav">
            <li class="nav-item active">
              <div class="">
                <!-- <label for="prefecture-select">Choose a Prefecture</label> -->
                <select name="prefecture" id="pref-select">
                  <option value="">---Please Choose an option---</option>
                  <option value="SanChaung">San Chaung</option>
                  ...
                  <div class="col-md-7">
                    <div class="detail-box">
                      ...
                      <p>
                        ...
                        Here, you`ll find exciting giveaways, exclusive contests, and free product promotions—no strings attached. 
                        Whether you're here for the latest tech gadgets, gift cards, or special bundles, entering is quick and easy.
                        Stay tuned for new campaigns, check our current offers below, and don`t miss your chance to win big. Good luck!
                      </p>
                      <a href="">
                        Contact Us
                      </a>
  ...
  <?= $this->Html->script(['jquery-3.4.1.min', 'bootstrap', 'custom'])
